...
export default function Home() {
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-900 text-gray-100">
            {/* Header */}
            <header className="bg-gray-800 border-b border-gray-700 p-4 flex flex-col md:flex-row items-center justify-between shrink-0">
                {/* Logo */}
                <div className="w-32 md:w-40 h-auto mb-4 md:mb-0">
                    <Image
